...
#  model_name = "./sports1m_finetuning_ucf101.model"
  model_name = "models/c3d_ucf_model-350"
  test_list_file = 'test.list'
  num_test_videos = len(list(open(test_list_file,'r')))
  print("Number of test videos={}".format(num_test_videos),flush=True)
  ...
  for step in xrange(all_steps):
    ...
    for i in range(0, valid_len):
      ...
      write_file.write('{}, {}, {}, {}\n'.format(
              ...
              predict_score[i][top1_predicted_label]).encode())
      if true_label[0] == top1_predicted_label:
        num_right = num_right + 1
      print('accuracy = ',num_right,'   ',num_times,'   ',num_right/num_times)
  write_file.close()
